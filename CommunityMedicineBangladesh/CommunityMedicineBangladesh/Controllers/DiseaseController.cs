...
namespace CommunityMedicineBangladesh.Controllers
{
    public class DiseaseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="DiseaseId,Name,Description,TreatmentProcedure,PreferredDrugs,Treatments")] Disease disease)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="DiseaseId,Name,Description,TreatmentProcedure,PreferredDrugs,Treatments")] Disease disease)
        {
            if (ModelState.IsValid)
            {
